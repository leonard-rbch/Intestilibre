  ...
  return (
    <div className="bg-[#fefaee]">
      ...
      <main> {/* Décalage pour le header fixe */}
        ...
        >
          {/* Titre centré */}
          <h1 className="text-[6vw] lg:text-[3vw] font-bold text-center w-full">
            Mentions Légales
          </h1>

          {/* Zone 1 */}
          <p className="text-left w-full text-[3vw] lg:text-[1.5vw] leading-[1.5]">
          Éditeur du site : <br/>
          - Margueritte Enzo <br/>
          - Entreprise individuelle<br/>
          - Adresse : 4 rue Leroy, 14000 Caen – France<br/>
          - SIRET : 989 795 851 00017<br/>
          - Email : contact@intestilibre.com<br/>
          ...
          Hébergeur :<br/>
          - Koyeb SAS<br/>
          - 9 rue des Longs Prés, 92100 Boulogne-Billancourt, France<br/>
          - Site web : www.koyeb.com | Téléphone : +33 (0)1 85 09 77 75
          </p>

          {/* Zone 3 */}
          <p className="text-left w-full text-[3vw] lg:text-[1.5vw] leading-[1.5]">
          Prestataire technique complémentaire :<br/>
        ...
        >
          ...
          {/* Zone 3 */}
          <p className="text-left w-full text-[3vw] lg:text-[1.5vw] leading-[1.5]">
          Article 3 – Services proposés<br/>
          Le site propose :<br/>
          - Des informations sur le syndrome de l’intestin irritable (SII).<br/>
          - Des documents gratuits envoyés par email.<br/>
          ...
          {/* Zone 5 */}
          <p className="text-left w-full text-[3vw] lg:text-[1.5vw] leading-[1.5]">
          Article 4 – Responsabilité<br/>
          L’éditeur met tout en œuvre pour assurer la qualité des contenus. Cependant, il ne peut être
          tenu responsable :<br/>
          - Des erreurs ou omissions ;<br/>
          - Des résultats liés à l’utilisation des informations fournies ;<br/>
        ...
        >
          ...
          {/* Zone 2 */}
          <p className="text-left w-full text-[3vw] lg:text-[1.5vw] leading-[1.5]">
          Article 2 – Description des services<br/>
          ...
          {/* Zone 4 */}
          <p className="text-left w-full text-[3vw] lg:text-[1.5vw] leading-[1.5] ml-[5vw]">
          ...
          {/* Zone 7 */}
          <ul className="list-disc text-left w-full text-[3vw] lg:text-[1.5vw] leading-[1.5] mx-[5vw]">
            <li>
          ...
          {/* Zone 17 */}
          <p className="text-left w-full text-[3vw] lg:text-[1.5vw] leading-[1.5]">
          Les rendez-vous des consultations sont planifiés via la plateforme <span className="font-bold">EasyRdv</span>, un service externe de prise de rendez-vous en ligne.<br/>
          Lors de la réservation, certaines données personnelles (nom, prénom, e-mail, téléphone, date et horaire de rendez-vous) sont collectées afin d’assurer la gestion de la consultation.<br/>
          EasyRdv agit en tant que <span className="font-bold">sous-traitant</span> au sens du RGPD et s’engage à respecter la confidentialité et la sécurité de ces données.<br/>
          Pour plus d’informations, consultez la politique de confidentialité d’EasyRdv : https://www.easyrdv.com/mentions-legales
          </p>

          {/* Zone 18 */}
          <p className="text-left w-full text-[3vw] lg:text-[1.5vw] leading-[1.5]">
          Article 4 – Prix et paiement<br/>
          - Les prix sont indiqués en euros TTC (TVA non applicable, art. 293B du CGI).<br/>
          - Paiement possible par Stripe (carte bancaire) ou virement bancaire (sur facture).<br/>
          ...
          {/* Zone 20 */}
          <p className="text-left w-full text-[3vw] lg:text-[1.5vw] leading-[1.5]">
          Article 6 – Annulation et remboursement<br/>
          - Toute consultation annulée moins de 24h avant l’horaire prévu reste due.<br/>
          - Les remboursements sont effectués par le même moyen de paiement que celui utilisé lors de la commande.
          </p>

          {/* Zone 21 */}
          <p className="text-left w-full text-[3vw] lg:text-[1.5vw] leading-[1.5]">
          Article 7 – Responsabilité<br/>
          ...
          {/* Zone 22 */}
          <p className="text-left w-full text-[3vw] lg:text-[1.5vw] leading-[1.5]">
          Article 8 – Droit applicable et juridiction<br/>
        ...
        >
          ...
          {/* Zone 1 */}
          <p className="text-left w-full text-[3vw] lg:text-[1.5vw] leading-[1.5]">
          Article 1 – Responsable du traitement<br/>
          Le responsable du traitement des données personnelles est : Margueritte Enzo – contact@intestilibre.com
          </p>

          {/* Zone 2 */}
          <p className="text-left w-full text-[3vw] lg:text-[1.5vw] leading-[1.5]">
          Article 2 – Données collectées<br/>
          - Identité et contact (nom, prénom, email) ;<br/>
          - Données de paiement (gérées par Stripe) ;<br/>
          ...
          {/* Zone 3 */}
          <p className="text-left w-full text-[3vw] lg:text-[1.5vw] leading-[1.5]">
          Article 3 – Finalités du traitement<br/>
          - Fournir les prestations commandées ;<br/>
          - Gérer la relation client (emails, factures) ;<br/>
          - Envoyer des newsletters ou e-books (si consentement donné) ;<br/>
          ...
          {/* Zone 5 */}
          <p className="text-left w-full text-[3vw] lg:text-[1.5vw] leading-[1.5]">
          Article 4 – Bases légales du traitement<br/>
          - Exécution d’un contrat (consultations, programmes) ;<br/>
          - Consentement (newsletter, cookies) ;<br/>
          - Intérêt légitime (sécurité du site) ;<br/>
          - Obligation légale (facturation, conservation comptable).
          </p>

          {/* Zone 6 */}
          <p className="text-left w-full text-[3vw] lg:text-[1.5vw] leading-[1.5]">
          Article 5 – Destinataires des données<br/>
          Les données sont destinées à :<br/>
          ...
          {/* Zone 10 */}
          <p className="text-left w-full text-[3vw] lg:text-[1.5vw] leading-[1.5]">
          Article 6 – Durée de conservation<br/>
          - Données prospects : 3 ans à compter du dernier contact émanant de l’utilisateur ;<br/>
          - Données clients : 3 ans après la fin de la relation contractuelle ;<br/>
          ...
          {/* Zone 11 */}
          <p className="text-left w-full text-[3vw] lg:text-[1.5vw] leading-[1.5]">
          Article 7 – Sécurité des données<br/>
          ...
          {/* Zone 12 */}
          <p className="text-left w-full text-[3vw] lg:text-[1.5vw] leading-[1.5]">
          Article 8 – Droits des utilisateurs<br/>
          Conformément au RGPD, toute personne dispose des droits suivants :<br/>
